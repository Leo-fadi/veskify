...
requireText("docs/VESKIFY_DEVELOPMENT_ROADMAP.md", [
  ...
  "accepted P10B-18A, accepted P10B-18B-01, accepted P10B-18B-06, and accepted\nP10B-18B-02 are Baseline",
  "parent P10B-18B, P10B-18, and P10B remain **Partial**",
  "P10B-18B-03 is the next focused product task",
...
requireText("docs/VESKIFY_DEVELOPMENT_DELIVERY_TRACKER.md", [
  ...
  "accepted P10B-18A,\naccepted P10B-18B-01, accepted P10B-18B-06 and accepted P10B-18B-02 are **Baseline**",
  "P10B-18B, P10B-18, and P10B remain **Partial**",
...
requireText("docs/P10B_18_COMMERCIAL_QUALITY_AUDIT.md", [
  ...
  "P10B-18A, P10B-18B-01, P10B-18B-06 and P10B-18B-02 are Baseline; parent P10B-18B, P10B-18 and\nP10B are Partial",
  "P10B-18B-03 is next and P10B-18C remains Planned",
...
requireText("docs/VESKIFY_CURRENT_STATE_TRUTH_AUDIT.md", [
  ...
  "Accepted P10B-18B-02 closes bounded homepage/editorial/campaign quality",
  "Parent P10B-18B\nand P10B-18 remain **Partial**. P10B-18B-03 is next, P10B-18C remains\nPlanned",
  "P10B-16P-05B remains Planned after P10B-18C",
]);

requireText("docs/VESKIFY_CAPABILITY_EVIDENCE_LEDGER.md", [
  "**P10B-18 status:** P10B-18A **Baseline / accepted 16 August 2026**; P10B-18B-01\n**Baseline / accepted 17 August 2026**; P10B-18B-06 **Baseline / accepted 17 August 2026**;\nP10B-18B-02 **Baseline / accepted 18 August 2026**",
  "P10B-18B-03 is next, P10B-18C commercial-quality/100+ scale acceptance\nremains Planned",
...
if ((tracker.match(/☑/g) ?? []).length !== 36) {
  failures.push("Delivery tracker must contain exactly thirty-six completed checkboxes");
}
...
if (
  ...
  failures.push(
    "Delivery tracker must mark P10B-01 through P10B-17, P10B-16P-01 through P10B-16P-05A, P10B-16P-06, P10B-18A, P10B-18B-01, P10B-18B-06, and P10B-18B-02 Baseline; keep parent P10B-18B and P10B-18 Partial; and keep P10B-18B-03, P10B-18C, and P10B-16P-05B Planned",
  );
}
