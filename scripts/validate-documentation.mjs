...
requireText("docs/VESKIFY_DEVELOPMENT_ROADMAP.md", [
  ...
  "accepted P10B-18A, accepted P10B-18B-01, and accepted P10B-18B-06 are Baseline",
  "parent P10B-18B, P10B-18, and P10B remain **Partial**",
  "P10B-18B-02 is the next focused product task",
...
requireText("docs/VESKIFY_DEVELOPMENT_DELIVERY_TRACKER.md", [
  ...
  "accepted P10B-18A,\naccepted P10B-18B-01 and accepted P10B-18B-06 are **Baseline**",
  "P10B-18B, P10B-18, and P10B remain **Partial**",
...
requireText("docs/P10B_18_COMMERCIAL_QUALITY_AUDIT.md", [
  ...
  "P10B-18A, P10B-18B-01 and P10B-18B-06 are Baseline; parent P10B-18B, P10B-18 and\nP10B are Partial",
  "P10B-18B-02 is next and P10B-18C remains Planned",
...
requireText("docs/DEVELOPMENT_GUIDE.md", [
  ...
  "parent\nP10B-18B, P10B-18, and P10B remain **Partial**",
  "P10B-18B-02 is next after accepted P10B-18B-06;\nP10B-18C remains **Planned**",
  "P10B-16P-05B remains **Planned** after P10B-18C",
...
requireText("docs/VESKIFY_CURRENT_STATE_TRUTH_AUDIT.md", [
  ...
  "Parent P10B-18B and P10B-18 remain **Partial**. P10B-18B-02 is next, P10B-18C remains\nPlanned",
  "P10B-16P-05B remains Planned after P10B-18C",
]);
...
requireText("docs/VESKIFY_CAPABILITY_EVIDENCE_LEDGER.md", [
  ...
  "parent\nP10B-18B and P10B-18 **Partial**; P10B-18B-02 is next; P10B-18C and P10B-16P-05B after it remain\n**Planned**",
...
if ((tracker.match(/☑/g) ?? []).length !== 35) {
  failures.push("Delivery tracker must contain exactly thirty-five completed checkboxes");
}
