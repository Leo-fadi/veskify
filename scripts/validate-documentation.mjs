...
const expectedPlannedP10bChecklistIds = lockedP10BTasks
  ...
  .filter(
    (taskId) =>
      !["P10B-01", "P10B-02", "P10B-03", "P10B-04", "P10B-05", "P10B-06"].includes(taskId),
  );
if (
  ...
  failures.push(
    "Delivery tracker must mark P10B-01 through P10B-06 Baseline and keep P10B-07 through P10B-18 Planned and unchecked",
  );
}
