...
const expectedPlannedP10bChecklistIds = lockedP10BTasks
  .map(([taskId]) => taskId)
  .filter((taskId) => taskId !== "P10B-01" && taskId !== "P10B-03");
if (
  ...
  failures.push(
    "Delivery tracker must mark P10B-01 and P10B-03 Baseline and list the other P10B tasks as Planned unchecked tasks",
  );
}
