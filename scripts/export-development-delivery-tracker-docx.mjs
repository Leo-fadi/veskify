...
try {
  exportMarkdownDocx({
    ...
    coverLines: [
      ...
      "Effective upon explicit AR-02C acceptance/merge: AR-02A, AR-02B, AR-02C, and AR-03A Baseline / closed; AR-02 and AR-03 Partial; AR-23 eligible / unstarted; no third child selected",
