...
try {
  exportMarkdownDocx({
    ...
    coverLines: [
      ...
      "Effective upon independently verified AR-02L acceptance/merge: AR-02A through AR-02L Baseline / closed; AR-02 Partial with the coordinated-direction metadata path remaining; AR-03 and AR-03A through AR-03E remain closed; AR-04/AR-05 dependency-blocked and unstarted; AR-06 depends on AR-05; AR-23 eligible / unstarted; BATCH-09 complete after L merge and safe closeout; no next task",
