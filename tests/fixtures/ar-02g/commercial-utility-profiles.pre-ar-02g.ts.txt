...
const inputs: readonly UtilityInput[] = [
  ...
  },
  {
    ...
    role: "orientation",
    frames: ["commerce-utility", "centered-minimal", "editorial-masthead", "compact-technical"],
    defaultFrame: "commerce-utility",
  ...
  },
  {
    ...
    variant: "emptyState",
    role: "continuation",
    frames: ["centered-minimal", "editorial-masthead", "commerce-utility", "compact-technical"],
