...
const inputs: readonly UtilityInput[] = [
  {
    ...
    variant: "cart",
    role: "orientation",
    frames: ["commerce-utility", "compact-technical", "centered-minimal"],
  ...
  },
  {
    ...
    role: "orientation",
    frames: ["commerce-utility", "centered-minimal"],
    defaultFrame: "commerce-utility",
  ...
  },
  {
    ...
    variant: "emptyState",
    role: "continuation",
    frames: ["centered-minimal", "commerce-utility"],
  ...
  },
  {
    ...
    role: "service",
    frames: ["compact-technical", "commerce-utility", "centered-minimal"],
  ...
  },
  {
    ...
    variant: "notFound",
    role: "orientation",
    frames: ["centered-minimal", "editorial-masthead"],
    defaultFrame: "centered-minimal",
