...
export const promptedStorefrontStudioGenerationLineageSchema = z
  .object({
    ...
    explicitConstraintFingerprint: fingerprintSchema,
    trustedHintFingerprint: fingerprintSchema,
    materialDimensionFingerprints: z
      .object({
        designDna: fingerprintSchema,
        sharedFrame: fingerprintSchema,
        homepage: fingerprintSchema,
        collection: fingerprintSchema,
        productDetail: fingerprintSchema,
        pageSet: fingerprintSchema,
        componentVariants: fingerprintSchema,
        productCard: fingerprintSchema,
        narrative: fingerprintSchema,
        merchandising: fingerprintSchema,
        density: fingerprintSchema,
        responsive: fingerprintSchema,
        artDirection: fingerprintSchema,
      })
      .strict(),
