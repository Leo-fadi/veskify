...
>;
type AnnouncementBarMetadataInput = MetadataInput<
  typeof announcementBarContentSchema,
  typeof announcementBarPropsSchema,
  typeof designVocabularyVariants.announcementBar
>;
type HeaderMetadataInput = MetadataInput<
  typeof headerContentSchema,
  typeof headerPropsSchema,
  typeof designVocabularyVariants.header
>;
type FeaturedCategoriesMetadataInput = MetadataInput<
  typeof featuredCategoriesContentSchema,
  typeof featuredCategoriesPropsSchema,
  typeof designVocabularyVariants.featuredCategories
>;
type ProductGridMetadataInput = MetadataInput<
  typeof productGridContentSchema,
  typeof productGridPropsSchema,
  typeof designVocabularyVariants.productGrid
>;
type CampaignBannerMetadataInput = MetadataInput<
  typeof campaignBannerContentSchema,
  typeof campaignBannerPropsSchema,
  typeof designVocabularyVariants.campaignBanner
>;
type BrandStoryMetadataInput = MetadataInput<
  typeof brandStoryContentSchema,
  typeof brandStoryPropsSchema,
  typeof designVocabularyVariants.brandStory
>;
type BenefitIconsMetadataInput = MetadataInput<
  typeof benefitIconsContentSchema,
  typeof benefitIconsPropsSchema,
  typeof designVocabularyVariants.benefitIcons
>;
type NewsletterMetadataInput = MetadataInput<
  typeof newsletterContentSchema,
  typeof newsletterPropsSchema,
  typeof designVocabularyVariants.newsletter
>;
type FooterMetadataInput = MetadataInput<
  typeof footerContentSchema,
  typeof footerPropsSchema,
  typeof designVocabularyVariants.footer
>;

export const announcementBarMetadata = {
...
} satisfies AnnouncementBarMetadataInput;
...
} satisfies HeaderMetadataInput;
export const featuredCategoriesMetadata = {
...
} satisfies FeaturedCategoriesMetadataInput;
export const productGridMetadata = {
  type: "productGrid",
  label: "Product grid",
...
} satisfies ProductGridMetadataInput;
export const campaignBannerMetadata = {
  type: "campaignBanner",
...
} satisfies CampaignBannerMetadataInput;
export const brandStoryMetadata = {
  type: "brandStory",
  label: "Brand story",
...
} satisfies BrandStoryMetadataInput;
export const benefitIconsMetadata = {
  type: "benefitIcons",
  label: "Benefits",
  ...
  editorFields: { alignment: sectionAlignmentEditorField, ...sectionStyleEditorFields },
  protectedFields: { readOnlyPaths: ["benefits.*.icon"] },
} satisfies BenefitIconsMetadataInput;
...
} satisfies NewsletterMetadataInput;
...
} satisfies FooterMetadataInput;

/** Ordered renderer-free declarations for the later V2 adapter consumer. */
export const homepageMetadataDefinitions = {
  announcementBar: announcementBarMetadata,
  header: headerMetadata,
  featuredCategories: featuredCategoriesMetadata,
  productGrid: productGridMetadata,
  campaignBanner: campaignBannerMetadata,
  brandStory: brandStoryMetadata,
  benefitIcons: benefitIconsMetadata,
