...
export type StorefrontContent = Pick<
  StorefrontSnapshot,
  "brandSystem" | "navigation" | "pages" | "catalogueRef"
>;
...
export function canonicalValueString(value: unknown): string {
  return JSON.stringify(canonicalizeValue(value));
}

export function storefrontContent(snapshot: StorefrontSnapshot): StorefrontContent {
  return {
...
export function canonicalStorefrontContentString(snapshot: StorefrontSnapshot): string {
  return canonicalValueString(storefrontContent(snapshot));
}

export function canonicalStorefrontContentEqual(
  left: StorefrontSnapshot,
  right: StorefrontSnapshot,
): boolean {
  return canonicalStorefrontContentString(left) === canonicalStorefrontContentString(right);
}
