...
function runtimeFor(
  ...
  return { kind: "not-found", revision: "not-found-proof-r1", actions: ["return-home"] };
}
...
export function P10B13UtilityProofClient({
  ...
  const runtime = runtimeFor(profile.commercialUtility!.state, catalogue);
  const context = createStorefrontRenderContext({
    ...
    onCommerceUtilityIntent: setLastIntent,
  });
