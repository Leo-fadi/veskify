...
export function createP10bLiveSynthesisAcceptHandler({
  ...
  return async function POST(request: Request): Promise<Response> {
    ...
    try {
      const synchronization = await acceptP10bLiveSynthesisProposal({ ...body, environment });
