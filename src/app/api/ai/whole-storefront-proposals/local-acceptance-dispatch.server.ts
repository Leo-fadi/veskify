...
import type { createWholeStorefrontPlanningRouteHandler } from "./handler";
...
export async function dispatchLocalAcceptance(request: Request): Promise<Response | undefined> {
