...
| ☐    | P10B-19A-08  | Compatibility, Deterministic Selection and Normalized Topology Identity | **Planned / exact next**                   | Planned task owner                       | P10B-19A-07 merged                        | Add compatibility, deterministic selection and normalized topology identity without beginning v1 migration or runtime integration                                                                              |
...
P10B-19A-01 through P10B-19A-07 are Baseline, P10B-19A is Partial, and P10B-19A-08 - Compatibility, Deterministic Selection and Normalized Topology Identity is the exact next implementation task.
...
P10B-19A-07 are **Baseline**, and P10B-19A-08 is **Planned / exact next**. P10B-16P-04 acceptance evidence is retained in
...
diagnostic. P10B-19 PRE is Baseline. P10B-19A-01 through P10B-19A-07 are Baseline, P10B-19A is
Partial, and P10B-19A-08 - Compatibility, Deterministic Selection and Normalized Topology Identity
is the exact next implementation task, followed by planned
...
Selection and Normalized Topology Identity is the exact next implementation task, followed by planned P10B-19B through
P10B-19J.
...
P10B-19A-07 are Baseline, P10B-19A-08 - Compatibility, Deterministic Selection and Normalized
Topology Identity is the exact next implementation task, and P10B-19B through P10B-19J
remain Planned.
...
| Current  | P10B-19A                  | **Partial**              | Structural Storefront Family and PageBlueprint v2 contracts, registry, topology identity, deterministic selection, and v1 compatibility |
...
| Next     | P10B-19A-08               | **Planned / exact next** | Compatibility, deterministic selection and normalized topology identity                                                                 |
