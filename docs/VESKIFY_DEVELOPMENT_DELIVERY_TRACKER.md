...
> **Candidate status effective upon explicit owner acceptance/merge of AR-02F:** This projection does not
> claim that this PR has merged or that owner acceptance has occurred.
> **AR-00 current status authority:** **Baseline / closed.** AR-01 is **Baseline / closed.** AR-02A is **Baseline / closed.** AR-02B is **Baseline / closed.** AR-02C is **Baseline / closed.** AR-02D is **Baseline / closed.** AR-02E is **Baseline / closed.** AR-02F is **Baseline / closed upon explicit owner acceptance/merge.**
...
> visual work. BATCH-03 has no successor child. This tracker owns current status; the roadmap owns dependency order.
...
| Child  | Parent | Bounded outcome and evidence                                                                                                                                                | Status effective on AR-02F acceptance/merge |
| ------ | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
...
| AR-02F | AR-02  | Adapt V2 definitions from shared renderer-free metadata; [contract](governance/task-contracts/AR/AR-02F.json), [report](AR_02F_IMPLEMENTATION_REPORT.md)                    | **Baseline / closed** upon acceptance/merge |
