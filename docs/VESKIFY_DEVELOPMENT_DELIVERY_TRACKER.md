...
> **Candidate status effective upon explicit owner acceptance/merge of AR-03B:** This projection does not
...
> AR-03A is **Baseline / closed.** AR-03B is **Baseline / closed upon explicit owner acceptance/merge.** AR-23 is **Planned / unstarted**. AR-23 depends on AR-01 and is not serialized behind
> visual work. BATCH-03 is complete. BATCH-04 is complete. AR-03C is the sole next task after AR-03B acceptance/merge and safe main synchronization. BATCH-05 selects no third task. This tracker owns current status; the roadmap owns dependency order.
...
| Child  | Parent | Bounded outcome and evidence                                                                                                                                                                  | Status effective on AR-03B acceptance/merge |
| ------ | ------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
...
| AR-03B | AR-03  | Renderer-free presentation construction and exact historical compatibility; [contract](governance/task-contracts/AR/AR-03B.json), [report](AR_03B_IMPLEMENTATION_REPORT.md)                   | **Baseline / closed** upon acceptance/merge |
