...
| P10A-08 | Add the deterministic publish compiler. P10A-08B supplies accepted-snapshot authority; P10A-08C-01 enforces it through the authenticated merchant publish gateway. P10A-08C-02 retains compiler/runtime and rollback closure. | AC-133 and AC-135 pass; publication makes no AI call. |
