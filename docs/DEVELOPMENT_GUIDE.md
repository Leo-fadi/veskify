...
> **AR-05B canonical-composition candidate projection:** This repository state takes effect upon accepted
> merge of AR-05B; it does not assert the PR's lifecycle or owner acceptance.
