...
> **AR-06A static-rendering candidate projection:** This repository state takes effect upon accepted
> merge of AR-06A; it does not assert the PR's lifecycle or owner acceptance.
