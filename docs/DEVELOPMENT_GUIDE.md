...
> **AR-04 composition-boundary candidate projection:** This repository state takes effect upon accepted
> merge of AR-04; it does not assert the PR's lifecycle or owner acceptance.
...
> AR-02 is Baseline / closed; complete original acceptance is mapped in AR_02_BOUNDARY_ACCEPTANCE.md. AR-04 is Baseline / closed effective upon accepted merge. AR-05 is eligible / unstarted; AR-06 remains dependent on AR-05. AR-03 is Baseline / closed.
