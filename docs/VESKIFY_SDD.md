...
> **AR-00 incorporation (pending adoption/merge):** The normative
...
| 1.3.0 P10B-19A-10A | 3 September 2026 | P10B-19A-10A retained matrix inventory and frozen baseline lock | Delivery-decompose parent A-10 into A-10A retained inventory/frozen baseline, A-10B cross-authority integration/negative-failure matrix and A-10C retained execution/closure/product-owner architecture gate without changing accepted architecture or P10B-19B order; freeze one fresh-clone-safe checked inventory with 24 explicit gates, 76 exact task-base production-source hashes, nine zero-count v2 inactivity assertions, exact accepted 126-case/frozen-72 and A-09 metrics, current DEVX-01 CI discoverability and one stale-checked deterministic fingerprint; add zero production/runtime or merchant-visible change; keep A-10 and P10B-19A Partial and make A-10B exact next. |
| 1.3.0 P10B-19A-09C | 3 September 2026 | P10B-19A-09C publication replay and P10B-19A-09 closure baseline | Bind exact A-09B read provenance to the current canonical publication compiler using truthful manual source authority and a transient historical-draft projection; require current migration without write-back; return strict immutable replay receipts; match three direct compilations, three preparations and exactly three isolated atomic confirmations with active compiled-artifact/version integrity; match 36 of 36 published and 36 of 36 normalized Preview/published structural observations with zero provider, Vesko or external-publication calls; preserve source snapshots, current generation, v2 and merchant-visible behavior; close parent A-09 while P10B-19A remains Partial and make A-10 exact next. |
| 1.3.0 P10B-19A-09B | 3 September 2026 | P10B-19A-09B historical v1 snapshot read and render replay baseline | Add a strict read-only current-canonical snapshot adapter; accept only exact-bound optional A-09A replay references or report readable-unattributed state without lineage inference; distinguish seven present verified persisted selection fields from seven absent unverified fields; return deterministic immutable receipts with `none` or `canonical-read-defaults` normalization disposition and `legacy-v1-historical-snapshot-read-v1_<canonical-length>_<sha256>` identity; match 36 of 36 frozen exact-base current-renderer observations across EN/FI with zero snapshot mutation, repository write, commerce/media change or route/profile/frame mismatch; preserve migration, publication replay, v2 and merchant-visible authority for later tasks; make A-09C exact next while parent A-09 and P10B-19A remain Partial. |
| 1.3.0 P10B-19A-09A | 2 September 2026 | P10B-19A-09A legacy v1 replay alias and compatibility reference baseline | Delivery-decompose parent A-09 into A-09A opaque alias/reference authority, A-09B historical snapshot read/render replay and A-09C publication replay/closure; add exactly three ordered legacy-v1 aliases bound to current coordinated-direction version `1.1.0` and package fingerprints; reuse the exact current selection-narrowing validator and executable projection; exclude incidental `selectionId` from replay fingerprint identity; preserve current v1 generation and all snapshot, persistence, renderer, publication and v2 authority; make A-09B the exact next task while A-09 and P10B-19A remain Partial. |
| 1.3.0 P10B-19A-08C | 2 September 2026 | P10B-19A-08C scoring-free deterministic candidate-selection baseline | Add strict schema/policy-version `1.0.0` trusted selection requests; establish typed family and PageBlueprint compatibility precedence with case-bound canonical fingerprint ties; select one exact family and six PageBlueprint sources through bounded A-06 substitution/omission authority; derive identity-free selected complete-store topology; replay stale-checked immutable receipts; preserve the empty production registry/profile/request/receipt and zero runtime, provider, persistence, publication or visual effect; complete parent P10B-19A-08 and make P10B-19A-09 the exact next task. |
| 1.3.0 P10B-19A-08B | 2 September 2026 | P10B-19A-08B candidate compatibility contract and evaluation baseline | Add strict schema-version `1.0.0` transient capability-context and exact A-04 required-role capacity evidence; add exact A-07-bound family compatibility profiles and one empty production catalogue; deterministically classify PageBlueprint and family candidates through memoized A-06 DAG evaluation while retaining all compatible targets; bind A-08A topology only as provenance; add stale-checked context, profile and aggregate fingerprints; preserve zero production candidates/profiles/contexts/evaluations/selection/runtime consumers; make P10B-19A-08C the exact next task. |
| 1.3.0 P10B-19A-08A | 1 September 2026 | P10B-19A-08A normalized topology identity baseline | Delivery-decompose accepted parent P10B-19A-08 into A-08A/A-08B/A-08C without changing architecture or A-09 order; add strict schema-version `1.0.0` normalized PageBlueprint v2 and Structural Storefront Family topology projections; assign deterministic region tokens from A-03 reading order; retain A-03/A-05 and exclude A-04/A-06 authority; add stale-checked topology fingerprints and a pure inactive duplicate-topology index; preserve the exactly empty production registry, zero topology records and no compatibility, selection, activation, persistence or runtime reachability; make P10B-19A-08B the exact next task. |
| 1.3.0 P10B-19A-07 | 1 September 2026 | P10B-19A-07 inactive family registry and candidate fingerprints baseline | Add strict deeply readonly PageBlueprint v2 and Structural Storefront Family candidate authorities at schema version `1.0.0`; compose exact A-03/A-04/A-05/A-06 authority; bind exact A-01 identity and candidate lifecycle; require all six A-02 page-family roles and canonical relationships; add stale-checked exact-content fingerprints; canonicalize a bounded inactive registry; reject duplicate identities, invalid A-06 targets and substitution cycles; keep its sole production value exactly empty; preserve A-01 through A-06/v1 and zero records, selectors and runtime consumers; make P10B-19A-08 the exact next task. |
| 1.3.0 P10B-19A-06 | 1 September 2026 | P10B-19A-06 PageBlueprint v2 omission, substitution and fallback contract baseline | Add one strict deeply readonly companion at schema version `1.0.0`; bind exact A-03/A-04/A-05 blueprint identity; own only the required-asset-role cardinality trigger; require exact triggerable-region coverage and required-region-safe terminal outcomes; preserve a bounded ordered whole-blueprint substitution chain; internally revalidate maximum simultaneous optional omission; preserve A-03/A-04/A-05/v1 bytes and zero record/runtime-consumer counts; make P10B-19A-07 the exact next task. |
| 1.3.0 P10B-19A-05 | 1 September 2026 | P10B-19A-05 PageBlueprint v2 responsive-rule contract baseline | Add one strict deeply readonly companion contract at schema version `1.0.0`; bind exact blueprint ID/version to explicit `mobile`/375, `tablet`/768, `desktop`/1024 and `wide`/1440 rules; require an existing structural order alternative and complete region/relationship coverage at every breakpoint; constrain proportions and relationship-kind transformations; canonicalize by breakpoint, selected reading order and A-03 relationship order; preserve accessibility, A-03/A-04/v1 bytes and zero record/runtime-consumer counts; make P10B-19A-06 the exact next task. |
| 1.3.0 P10B-19A-04 | 1 September 2026 | P10B-19A-04 PageBlueprint v2 asset-role compatibility contract baseline | Preserve and expose the canonical ordered nine-role `AssetRole` authority; add one strict deeply readonly companion contract at schema version `1.0.0`; bind exact blueprint ID/version and known regions; validate explicit required/optional role cardinality through maximum 32; canonicalize by structural default reading order and canonical role order; preserve A-03/v1 bytes and keep contract-record and runtime-consumer counts zero; make P10B-19A-05 the exact next task. |
...
Baseline. P10B-19A-01 through P10B-19A-08C are Baseline; parent P10B-19A-08 is Baseline / closed.
P10B-19A-09A, P10B-19A-09B, P10B-19A-09C, P10B-19A-10A, P10B-19A-10B1, P10B-19A-10B2 and
P10B-19A-10C are Baseline; parents P10B-19A-09, P10B-19A-10B, P10B-19A-10 and P10B-19A are
Baseline / closed. P10B-19B-01 is the exact next implementation task and is Planned / exact next;
it has not begun. P10B-19 and P10B remain Partial. The
current
...
Baseline/complete; P10B-18C and P10B-16P-05B are Baseline. P10B-18D is a Baseline diagnostic with
live commercial quality rejected. P10B-19 PRE is Baseline. P10B-19A-01 through P10B-19A-08C are
...
P10B-19A-09, P10B-19A-10B, P10B-19A-10 and P10B-19A are Baseline / closed. P10B-19B-01 is the
exact next implementation task and is Planned / exact next; it has not begun. P10B-19 and P10B
remain Partial.
...
P10B-19A-01 through P10B-19A-08C are Baseline; parent P10B-19A-08 is Baseline / closed.
P10B-19A-09A, P10B-19A-09B, P10B-19A-09C, P10B-19A-10A, P10B-19A-10B1, P10B-19A-10B2 and
P10B-19A-10C are Baseline; parents P10B-19A-09, P10B-19A-10B, P10B-19A-10 and P10B-19A are
Baseline / closed. P10B-19B-01 is the exact next implementation task and is Planned / exact next;
it has not begun. P10B-19 and P10B remain Partial.
...
2. **P10B — Commercial Storefront Generation System v1.** **Partial / active phase.** P10B-01
   ...
   P10B-19A-01 through P10B-19A-08C are Baseline; parent P10B-19A-08 is Baseline / closed.
   P10B-19A-09A, P10B-19A-09B, P10B-19A-09C, P10B-19A-10A, P10B-19A-10B1,
   P10B-19A-10B2 and P10B-19A-10C are Baseline; parents P10B-19A-09, P10B-19A-10B,
   P10B-19A-10 and P10B-19A are Baseline / closed. P10B-19B-01 is the exact next implementation
   task and is Planned / exact next; it has not begun. P10B-19 and P10B remain Partial.
...
diagnostic is complete with live commercial quality rejected. P10B-19 PRE is Baseline.
P10B-19A-01 through P10B-19A-08C are Baseline; parent P10B-19A-08 is Baseline / closed.
P10B-19A-09A, P10B-19A-09B, P10B-19A-09C, P10B-19A-10A, P10B-19A-10B1, P10B-19A-10B2 and
P10B-19A-10C are Baseline; parents P10B-19A-09, P10B-19A-10B, P10B-19A-10 and P10B-19A are
Baseline / closed. P10B-19B-01 is the exact next implementation task and is Planned / exact next;
...
locked order is P10B-19 PRE Baseline; P10B-19A-01 through P10B-19A-07, P10B-19A-08A through
P10B-19A-08C, P10B-19A-09A through P10B-19A-09C, P10B-19A-10A, P10B-19A-10B1 and
P10B-19A-10B2 and P10B-19A-10C Baseline; parents P10B-19A-08, P10B-19A-09, P10B-19A-10B,
P10B-19A-10 and P10B-19A Baseline / closed; P10B-19B-01 exact next and Planned / exact next but
not begun; then the remaining P10B-19B through P10B-19J work. P10B-19 and P10B remain Partial.
...
`P10B-19A-02 = Baseline`; `P10B-19A-03 = Baseline`; `P10B-19A-04 = Baseline`;
`P10B-19A-05 = Baseline`; `P10B-19A-06 = Baseline`; `P10B-19A-07 = Baseline`;
`P10B-19A-08A = Baseline`; `P10B-19A-08B = Baseline`; `P10B-19A-08C = Baseline`;
`P10B-19A-08 = Baseline / closed`; `P10B-19A-09A = Baseline`;
`P10B-19A-09B = Baseline`; `P10B-19A-09C = Baseline`; `P10B-19A-10A = Baseline`;
`P10B-19A-09 = Baseline / closed`; `P10B-19A-10B1 = Baseline`;
`P10B-19A-10B = Baseline / closed`; `P10B-19A-10B2 = Baseline`;
`P10B-19A-10C = Baseline`; `P10B-19A-10 = Baseline / closed`;
`P10B-19A = Baseline / closed`; `P10B-19B-01 = exact next implementation task`;
`P10B-19 = Partial`; `P10B = Partial`; P10B-19B through P10B-19J remain Planned.
...
adapter boundary remain binding. P10B remains Partial. P10B-19A-01 through P10B-19A-08C are
Baseline; parent P10B-19A-08 is Baseline / closed. P10B-19A-09A, P10B-19A-09B and
P10B-19A-09C, P10B-19A-10A, P10B-19A-10B1, P10B-19A-10B2 and P10B-19A-10C are Baseline; parents
P10B-19A-09, P10B-19A-10B, P10B-19A-10 and P10B-19A are Baseline / closed. P10B-19B-01 is the
exact next implementation task and is Planned / exact next; it has not begun. P10B-19 and P10B
...
P10B-19A-04 adds one companion sub-contract under the sole PageBlueprint authority in
`src/application/storefront-templates/page-blueprint-v2-asset-role-contract.ts`. It does not extend
the A-03 v1/v2 dispatch envelope or duplicate the structural blueprint. The companion binds to the
exact validated A-03 `id`, supported record `version`, and region IDs. The A-03 structural core and
dispatch remain byte-identical, and existing PageBlueprint v1 records, direct parsing, registry,
resolution, materialization, replay, snapshot references, and publication behavior remain
unchanged.

`src/domain/shared/asset-role.ts` remains the sole canonical presentation-role authority. It now
exposes one readonly ordered `assetRoleValues` tuple from which the unchanged `assetRoleSchema` and
`AssetRole` type are derived. Its exact order is `logo`, `heroDesktop`, `heroMobile`,
`collectionImage`, `productMainImage`, `productAlternativeImage`, `editorialImage`,
`supportingContentImage`, and `iconDecorative`. No role, alias, case conversion, whitespace
normalization, friendly label, fallback value, persisted value, or import owner is added or
changed. The separate coarse source-discovery evidence vocabulary is not PageBlueprint role
authority.

The compatibility contract schema version is exactly `1.0.0` and is independent from the
PageBlueprint v2 structural contract schema version and blueprint record version. Its strict root
contains only `contractSchemaVersion`, `blueprintId`, `blueprintVersion`, and
`regionAssetRequirements`. A region entry contains only `regionId` and a non-empty
`roleRequirements` collection. A role entry contains only canonical `role`, explicit `requirement`
of `required` or `optional`, and `cardinality`. Missing or unsupported versions, identities, or
fields fail closed; an empty top-level region collection is explicitly valid and declares no
asset-role authority. An omitted region likewise accepts no roles through this contract.

Role cardinality contains integer `minimum`, `ideal`, and `maximum`. Minimum and ideal are
nonnegative, maximum is positive and at most 32, and `minimum <= ideal <= maximum`. A required role
has minimum at least one; an optional role has minimum exactly zero. A required role on an optional
structural region is valid and applies only when that region is realized. This contract does not
force realization or evaluate current asset availability.

The pure binder first validates and canonicalizes the structural blueprint through the unchanged
A-03 parser, then strictly validates the companion and checks exact blueprint ID/version, known
regions, unique region entries, and unique roles within each region. Duplicate and unknown-region
evidence is bounded, deterministic, safe, free of raw object serialization, and ordered by the
structural default reading order followed by canonical role order. Only completely valid input is
canonicalized: region entries follow the default structural order and roles follow
`assetRoleValues`. Equivalent valid permutations return identical deeply readonly output; invalid
input is never normalized, deduplicated, repaired, defaulted, or mutated, and no fingerprint is
computed.

This declaration-only compatibility authority contains no asset ID, revision, source owner,
provenance, approval, material fingerprint, URL, media object, placement, component, availability,
allocation, reuse, crop, focal point, safe area, derivative, or responsive source. It adds no
breakpoint rule, `heroDesktop`/`heroMobile` pairing, responsive transformation, omission,
substitution, fallback, placeholder, degraded presentation, or repair behavior. Existing approved
asset placement, responsive-image, source-discovery, asset-review, generation context, canonical
product-media, commerce, component-slot, proposal, persistence, publication, and renderer owners
remain unchanged.

Active Structural Storefront Family record count, candidate family registry-record count,
PageBlueprint v2 registry-record count, persisted PageBlueprint v2 record count, asset-role
compatibility production-record count, production-selected asset-role contract count, and
current-generation asset-role-contract consumer count all remain zero. Exported schemas, types,
and the pure canonicalizer are inactive compatibility infrastructure for P10B-19A-05 through
P10B-19A-08; they are not records, selectors, provider fields, persisted state, or production
reachability.

`P10B-19A-01 = Baseline`; `P10B-19A-02 = Baseline`; `P10B-19A-03 = Baseline`;
`P10B-19A-04 = Baseline`; `P10B-19A = Partial`; `P10B-19A-05 = Planned / exact next`;
`P10B = Partial`.

### 10.35 P10B-19A-05 PageBlueprint v2 responsive-rule authority

P10B-19A-05 adds one companion sub-contract under the sole PageBlueprint authority in
`src/application/storefront-templates/page-blueprint-v2-responsive-rule-contract.ts`. It binds to
the exact validated A-03 blueprint `id` and supported record `version` without extending the
A-03 v1/v2 dispatch envelope. The A-03 structural contract, A-04 asset-role compatibility
contract, dispatch, and existing PageBlueprint v1 responsive grammar, responsive-image authority,
records, parsing, resolution, materialization, replay, snapshots, and publication behavior remain
byte-identical.

The responsive-rule contract schema version is exactly `1.0.0`. Its strict root contains only
`contractSchemaVersion`, `blueprintId`, `blueprintVersion`, and `breakpointRules`. It requires
exactly one rule for each of `mobile` at 375 px, `tablet` at 768 px, `desktop` at 1024 px, and
`wide` at 1440 px; canonical output uses that order. A strict breakpoint rule contains only `breakpoint`,
`viewport`, `orderAlternativeId`, `regionProportionRules`, and `relationshipTransformations`.
Breakpoint names and viewport anchors are exact pairs; duplicates, missing pairs, unsupported
names or anchors, and additional fields fail closed.

Every breakpoint selects one existing complete A-03 structural order alternative. It declares
every structural region exactly once through a strict `regionId` and `proportionMode` pair. The
closed proportion vocabulary is `preserve`, `compress`, `expand`, and `full-width`; no value hides,
omits, or conditionally removes a region. Every A-03 structural relationship is also declared
exactly once through its canonical `relationshipKey` and one explicit `transformation`. A
blueprint with zero structural relationships must use the explicit empty collection. Missing,
duplicate, reversed, unknown, wildcard, or implicitly preserved authority fails closed.

Relationship transformations are constrained by the relationship kind. `precedes` permits only
`preserve`; `pairs-with` permits `preserve` or `stack`; `offsets` permits `preserve` or
`remove-offset`; `contains` permits `preserve` or `flatten`; `spans` permits `preserve` or
`reduce-span`; and `anchors` permits `preserve` or `linearize`. These transformations describe
bounded structural responsive intent only. They do not change relationship kinds, endpoints,
region semantics, required-region status, or cardinality.

The pure binder first validates and canonicalizes the unchanged A-03 structural input, then
strictly validates the complete responsive input and its exact structural binding. Only valid
authority is canonicalized: breakpoint rules follow `mobile`, `tablet`, `desktop`, `wide`; region
rules follow the selected alternative's reading order at that breakpoint; and relationship
transformations follow canonical A-03 structural relationship order. Equivalent valid
permutations return identical deeply readonly output. Invalid input is never defaulted,
deduplicated, repaired, substituted, mutated, or fingerprinted.

The contract preserves every region and required region, semantic role, cardinality,
`precedes` constraint, and complete accessible reading order. A selected order alternative already
preserves containment parent-before-child ordering, including when a `contains` relationship uses
`flatten`; responsive reordering cannot introduce a second or partial reading order. This is
declaration-only compatibility infrastructure and adds no visibility, hide/omit, media, asset,
image, fallback, substitution, repair, CSS, grid, coordinate, percentage, media-query, component,
family definition, renderer, provider, persistence, publication, migration, current-runtime
behavior, or merchant-visible output.

Active Structural Storefront Family record count, candidate family registry-record count,
PageBlueprint v2 registry-record count, persisted PageBlueprint v2 record count, responsive-rule
production-record count, production-selected responsive-rule contract count, and
current-generation responsive-rule-contract consumer count all remain zero. The next child alone
owns omission, substitution, and fallback semantics.

`P10B-19A-01 = Baseline`; `P10B-19A-02 = Baseline`; `P10B-19A-03 = Baseline`;
`P10B-19A-04 = Baseline`; `P10B-19A-05 = Baseline`; `P10B-19A = Partial`;
`P10B-19A-06 = Planned / exact next`; `P10B = Partial`.

### 10.36 P10B-19A-06 PageBlueprint v2 omission, substitution and fallback authority

P10B-19A-06 adds one companion sub-contract under the sole PageBlueprint authority in
`src/application/storefront-templates/page-blueprint-v2-omission-substitution-fallback-contract.ts`.
It composes the exact validated A-03 structural, A-04 asset-role compatibility and A-05 responsive-
rule contracts without extending the A-03 v1/v2 dispatch envelope. The A-03, A-04 and A-05 source
modules, dispatch, existing v1 omission and evidence policies, component empty-state behavior,
responsive-image authority, records, parsing, resolution, materialization, snapshots and publication
behavior remain byte-identical.

The companion schema version is exactly `1.0.0`. Its strict root contains only
`contractSchemaVersion`, `blueprintId`, `blueprintVersion`, `blueprintSubstitutionCandidates`, and
`regionFallbackRules`. The pure binder first validates and canonicalizes A-03, A-04 and A-05, then
requires exact blueprint ID and record-version equality across all four contracts. Missing,
malformed, unsupported, mismatched or additional fields fail closed without defaulting, repair,
deduplication or input mutation.

The only trigger is `required-asset-role-cardinality-unsatisfied`. Triggerable regions are derived
from A-04: a region is triggerable when at least one of its role requirements is `required`. Every
and only triggerable region must have exactly one strict rule containing its `regionId`, the fixed
trigger and one terminal resolution. A region with multiple required roles still has one rule;
regions containing optional roles only have none. If A-04 contains no required role, both the rule
collection and substitution-candidate collection must be explicitly empty.

The closed terminal vocabulary is `omit-region` and `fail-closed`. `omit-region` is valid only for
an A-03 region whose structural requirement is `optional`; a structurally required region must use
`fail-closed`. `fail-closed` remains valid for either structural requirement. No missing rule or
terminal value implies omission, failure, preservation or wildcard authority.

`blueprintSubstitutionCandidates` is one global ordered chain of at most eight whole-PageBlueprint
v2 references. Each strict reference contains only `blueprintId` and `blueprintVersion`. Declared
order is semantic priority and is preserved exactly. The source blueprint ID, a duplicate target
blueprint ID even at another version, malformed identity or additional candidate metadata fails
closed. This task does not register targets, look them up, prove same-page-family compatibility,
select a target, merge blueprints or substitute individual regions, components or assets.
P10B-19A-07 owns inactive registration and candidate fingerprints; P10B-19A-08 owns later
compatibility, deterministic selection and normalized topology authority.

After full validation, region rules canonicalize by the A-03 default reading order while candidate
order remains unchanged. The output is deeply readonly. For every rule that terminates in
`omit-region`, the binder performs a bounded pure maximum-simultaneous-omission audit: it internally
removes the optional regions, incident relationships and corresponding entries from every order
alternative while preserving all remaining relative order and relationships, then revalidates the
temporary structural projection through unchanged A-03 authority. This proves that at least one
region, every minimum required page-family role, valid references, complete order alternatives and
acyclic accessibility/containment authority remain. The projection is not exported, returned,
persisted or fingerprinted; the source A-03 contract remains unchanged.

A-05 remains complete over the unmodified source structural blueprint. Future resolution of an
omitted region will remove its responsive region entries and incident relationship transformations
while preserving every breakpoint and every remaining declared value. A-06 does not implement that
responsive projection and does not add breakpoint-specific fallback, conditional visibility,
mobile-only omission, responsive asset substitution or inferred preserve behavior.

This is declaration-only compatibility infrastructure. It stores no current asset counts, asset
IDs, revisions, evidence, provenance, approval, commerce facts, capability scores, selected targets
or availability result. It performs no asset evaluation, target lookup, candidate compatibility,
selection, fallback execution, omission execution, resolved-blueprint generation, rendering,
provider call, persistence, publication or merchant-visible behavior.

Active Structural Storefront Family record count, candidate family registry-record count,
PageBlueprint v2 registry-record count, persisted PageBlueprint v2 record count, asset-role,
responsive-rule and fallback production-record counts, registered substitution-target count,
production-selected substitution count and current-generation fallback-consumer count all remain
zero.

`P10B-19A-01 = Baseline`; `P10B-19A-02 = Baseline`; `P10B-19A-03 = Baseline`;
`P10B-19A-04 = Baseline`; `P10B-19A-05 = Baseline`; `P10B-19A-06 = Baseline`;
`P10B-19A = Partial`; `P10B-19A-07 = Planned / exact next`; `P10B = Partial`.

### 10.37 P10B-19A-07 inactive family registry and candidate fingerprint authority

P10B-19A-07 adds strict, deeply readonly inactive candidate authority under the sole existing
storefront-template and Structural Storefront Family owners. It does not activate a family,
register a current production record, extend PageBlueprint dispatch, or create another page graph,
snapshot, component registry, selection system, persistence model, renderer, or runtime path.
Candidate schema versions and the inactive registry contract schema version are exactly `1.0.0`.

A PageBlueprint v2 candidate contains exactly `candidateSchemaVersion`, `structural`,
`assetRoleCompatibility`, `responsiveRules`, `omissionSubstitutionFallback`, and
`candidateFingerprint`. Creation validates and canonicalizes the exact A-03 structural, A-04
asset-role, A-05 responsive-rule, and A-06 omission/substitution/fallback authorities in dependency
order. Their blueprint ID and version must therefore remain one exact identity. Unknown fields,
malformed or mismatched composed authority, unsupported versions, and noncanonical supplied data
fail closed without defaults, repair, deduplication, or input mutation.

The PageBlueprint candidate reference reuses the exact A-06 reference shape: only `blueprintId` and
`blueprintVersion`. Its identity key is `<blueprintId>@<blueprintVersion>`. The candidate fingerprint
is computed over the complete canonical candidate composition excluding the fingerprint field. Its
exact format is `page-blueprint-v2-candidate-v1_<canonical-length>_<sha256>`. Supplied fingerprints
are stale-checked after canonicalization and mismatch rejects; they are never silently regenerated
by parsing.

A Structural Storefront Family candidate contains exactly `candidateSchemaVersion`, `familyId`,
`familyVersion`, `lifecycleState`, `pageFamilyProfiles`, `crossPageRelationships`, and
`candidateFingerprint`. It reuses exact A-01 family ID/version and requires the lifecycle state to
remain `candidate`. It contains exactly one profile entry for each of the six ordered A-02
page-family roles: `home`, `collection`, `search`, `product-detail`, `content-support`, and
`utility`. Every profile contains only `pageFamilyId` and one through eight unique exact
PageBlueprint candidate references. Cross-page relationships are nonempty strict A-02 relationship
records. Duplicate or missing page-family profiles, duplicate references, malformed relationships,
unknown fields, and any non-candidate lifecycle fail closed.

Family profiles canonicalize by A-02 page-family order. References canonicalize by code-unit
blueprint ID and precision-safe semantic version order. Cross-page relationships canonicalize
through unchanged A-02 authority. The family candidate fingerprint covers schema version, exact
A-01 family ID/version, canonical page-family profiles, and canonical cross-page relationships but
intentionally excludes lifecycle. Its exact format is
`structural-storefront-family-candidate-v1_<canonical-length>_<sha256>`. Supplied stale
fingerprints reject after canonicalization.

The strict inactive registry contains exactly `contractSchemaVersion`,
`pageBlueprintCandidates`, and `familyCandidates`. It accepts no more than 96 PageBlueprint
candidates and 24 family candidates. PageBlueprint candidates canonicalize by A-02 page-family
order, then code-unit blueprint ID and precision-safe semantic version; family candidates
canonicalize by A-01 family order and precision-safe semantic version. Exact PageBlueprint and
family candidate identities must be unique.

Every family profile reference must resolve to an exact registered PageBlueprint candidate in the
same A-02 page family. Every ordered A-06 whole-blueprint substitution target must resolve, must
differ from its source exact identity, and must remain in the source page family. Declared A-06
target priority is preserved. A three-colour exact-identity graph audit rejects direct, indirect,
and cross-version substitution cycles. Resolution and validation do not select or execute a target.

The sole exported production registry value has exactly empty `pageBlueprintCandidates` and
`familyCandidates` arrays. Active family-record count, candidate family-record count,
PageBlueprint candidate-record count, selected candidate count, persisted candidate count,
published candidate count, and current-generation candidate consumer count all remain zero. The
candidate fingerprints prove exact canonical content integrity; they are explicitly not normalized
topology identities and grant no compatibility, equivalence, diversity, selection, activation, or
runtime authority.

A-01 through A-06 source authority and current PageBlueprint v1 behavior remain unchanged.
`P10B-19A-01 = Baseline`; `P10B-19A-02 = Baseline`; `P10B-19A-03 = Baseline`;
`P10B-19A-04 = Baseline`; `P10B-19A-05 = Baseline`; `P10B-19A-06 = Baseline`;
`P10B-19A-07 = Baseline`; `P10B-19A-08A = Baseline`; `P10B-19A-08B = Baseline`;
`P10B-19A-08C = Baseline`; `P10B-19A-08 = Baseline / closed`;
`P10B-19A-09A = Baseline`; `P10B-19A-09B = Baseline`; `P10B-19A-09C = Baseline`;
`P10B-19A-09 = Baseline / closed`; `P10B-19A-10A = Baseline`;
`P10B-19A-10B1 = Baseline`; `P10B-19A-10B2 = Baseline`;
`P10B-19A-10B = Baseline / closed`; `P10B-19A-10C = Baseline`;
`P10B-19A-10 = Baseline / closed`; `P10B-19A = Baseline / closed`;
`P10B-19B-01 = exact next implementation task`; `P10B-19 = Partial`; `P10B = Partial`.

### 10.38 P10B-19A-08A normalized topology identity authority

P10B-19A-08A delivery-decomposes accepted parent P10B-19A-08 into A-08A normalized topology
identity, A-08B candidate compatibility contract and evaluation, and A-08C deterministic candidate
selection. This is a delivery-only split: the accepted P10B-19 PRE architecture, parent A-08
outcome and P10B-19A-09 v1 compatibility order remain unchanged. A-08A adds no compatibility,
selection, activation, persistence, publication, renderer, provider, merchant-context, asset-
availability, fallback-execution or runtime authority.

The exact schema-version constants are:

- `PAGE_BLUEPRINT_V2_NORMALIZED_TOPOLOGY_SCHEMA_VERSION = "1.0.0"`;
- `STRUCTURAL_STOREFRONT_FAMILY_NORMALIZED_TOPOLOGY_SCHEMA_VERSION = "1.0.0"`; and
- `INACTIVE_CANDIDATE_NORMALIZED_TOPOLOGY_INDEX_SCHEMA_VERSION = "1.0.0"`.

The strict PageBlueprint v2 projection parses exact A-07 candidate authority and assigns contiguous
`r0` through `rN` topology-region tokens in canonical A-03 default reading order. Its fingerprint
material contains only topology schema version, A-02 page-family role, normalized region semantics,
normalized A-03 relationships, explicit normalized reading orders and normalized A-05 responsive
structure. Region records retain narrative role, requirement, cardinality and visual weight.
Symmetric `pairs-with` endpoints canonicalize by token order; directional relationships preserve
direction. The default order is explicit, while duplicate non-default token orders collapse and
the remainder sort deterministically. The exact four A-05 breakpoint widths retain normalized
selected reading order, region proportions and relationship transformations. Blueprint IDs,
versions, region IDs and order-alternative IDs are absent. A-04 asset-role authority and A-06
omission, substitution and fallback authority are wholly excluded, so they may change an exact
A-07 candidate fingerprint without changing normalized topology.

The deeply readonly PageBlueprint projection carries a stale-checked fingerprint with exact format
`page-blueprint-v2-normalized-topology-v1_<canonical-length>_<sha256>`. Blueprint, region and
order-alternative renaming cannot change it. Region semantics, relationships, reading orders or
responsive hierarchy changes do change it. Missing, malformed, unknown, unsupported, incomplete,
noncanonical or stale input fails closed without repair, defaulting, mutation or inferred
authority.

The strict, deeply readonly Structural Storefront Family projection resolves exact A-07 references
through the supplied canonical inactive registry. It contains exactly one topology set for each of
the six canonical A-02 page-family roles — `home`, `collection`, `search`, `product-detail`,
`content-support` and `utility` — plus canonical A-02 cross-page relationships. Duplicate
PageBlueprint topology fingerprints inside one page-family role collapse. Family ID, family
version, lifecycle, exact PageBlueprint references and exact candidate fingerprints are absent
from fingerprint material. Its stale-checked fingerprint has exact format
`structural-storefront-family-normalized-topology-v1_<canonical-length>_<sha256>`.

One pure, non-persisted inactive index derives PageBlueprint and family topologies from the
unchanged A-07 registry, retains exact candidate identity and exact candidate fingerprint only as
diagnostic provenance, and reports deterministic duplicate PageBlueprint-topology and family-
topology clusters. Duplicate topology is diagnosed but never rejected, ranked, selected, activated
or declared meaningful. The index is not an exported populated production value, cache, persisted
record or runtime selector.

The sole production A-07 candidate registry remains exactly empty. Production PageBlueprint v2
record count, Structural Storefront Family record count and normalized-topology index record count
remain zero. A-01 through A-07 production authority, current v1 read/render/migration/publication
behavior, canonical commerce/media, `StorefrontSnapshot`, proposal lifecycle, Puck boundary and
publication are unchanged. Focused A-08A tests and the inactive A-08B compatibility evaluator are
current consumers; A-08B uses the topology index solely for provenance and exact-authority
validation. Named future consumers are A-08C deterministic selection, P10B-19H duplicate-concept
prevention and P10B-19G meaningfulness evidence.

`P10B-19A-01 through P10B-19A-07 = Baseline`; `P10B-19A-08A = Baseline`;
`P10B-19A-08B = Baseline`; `P10B-19A-08C = Baseline`;
`P10B-19A-08 = Baseline / closed`; `P10B-19A-09A = Baseline`;
`P10B-19A-09B = Baseline`; `P10B-19A-09C = Baseline`;
`P10B-19A-09 = Baseline / closed`; `P10B-19A-10A = Baseline`;
`P10B-19A-10B1 = Baseline`; `P10B-19A-10B2 = Baseline`;
`P10B-19A-10B = Baseline / closed`; `P10B-19A-10C = Baseline`;
`P10B-19A-10 = Baseline / closed`; `P10B-19A = Baseline / closed`;
...
P10B-19A-08B establishes inactive compatibility authority and answers which exact A-07
PageBlueprint v2 and Structural Storefront Family candidates are compatible, conditionally
compatible or incompatible, and why. It does not select a candidate, fallback or family; execute
omission; score, rank or tie-break; activate a family; persist an evaluation; or connect current
generation. P10B-19A-08C owns deterministic candidate selection.

The capability-context, family-profile, profile-catalogue and aggregate evaluation schema versions
are `1.0.0`. The closed ordered dimensions are `catalogue-cardinality`, `fact-depth`,
`product-complexity`, `navigation-depth` and `locale`. Catalogue cardinality and fact depth use
`sparse`, `standard`, `rich`; product complexity uses `simple`, `configurable`, `mixed`; navigation
depth uses `shallow`, `standard`, `deep`; and locale reuses the canonical `en`, `fi` order. These
are supplied compatibility projections, not values derived from commerce, content or media by this
task.

One strict, deeply readonly transient context carries those values, an active locale, nonempty
canonical available locales, and exactly one capacity-evidence entry for every and only evaluated
A-07 PageBlueprint candidate. Each entry binds the exact candidate fingerprint and contains every
and only A-04 role marked required, ordered by the A-03 default region order and canonical asset-
role order. `satisfiableMinimumCapacity` is an integer from zero through the exact A-04 maximum 32.
It means canonical approved-asset authority has already proved that many safe placements; A-08B
does not inspect assets, expose asset identity, decide reuse or infer missing evidence.

Each strict family compatibility profile binds one exact A-07 family candidate and contains one
policy for each dimension. Every policy explicitly and canonically partitions its complete
vocabulary into a nonempty supported set and a disjoint incompatible set. No wildcard, implicit
default, numeric threshold, expression, score, weight or priority exists. The sole exported
production compatibility-profile catalogue is strict, bounded, deeply readonly and exactly empty.
Catalogue binding requires one exact profile for every and only actual family candidate, so the
empty production registry requires the empty production catalogue.

PageBlueprint evaluation compares exact capacity only with each required A-04 minimum. Its ordered
statuses are `directly-compatible`, `substitution-compatible`, `omission-compatible` and
`incompatible`; terminal dispositions are `not-needed`, `substitution-candidates-available`,
`omit-triggered-regions` and `fail-closed`. A memoized traversal of the A-07-validated acyclic A-06
graph evaluates every direct substitution target recursively, retains every non-incompatible
target in declared A-06 order and never chooses one. With no compatible target, all triggered
regions must explicitly allow omission or the result fails closed. Directly compatible candidates
ignore dormant fallback declarations.

Family evaluation preserves A-07 family, A-02 page-family and family-reference order. Its statuses
are `directly-compatible`, `conditionally-compatible` and `incompatible`. Every current condition
must be supported. Direct compatibility also requires at least one directly compatible referenced
PageBlueprint in all six page families; conditional compatibility permits a non-incompatible
fallback/omission-compatible candidate in at least one page family; any unsupported condition or
page family with no non-incompatible candidate is incompatible. All eligible candidates remain
diagnostic output, and no PageBlueprint or family is selected.

The evaluator validates the exact deterministic A-08A index and includes page and family topology
fingerprints only as provenance. Topology equality or difference never changes compatibility. The
stale-checked fingerprints are exactly
...
Fingerprint material contains canonical compatibility authority and excludes timestamps,
merchant/project/store identity, raw assets/commerce/provider data, selection, rank and score.

The production PageBlueprint candidate count, family-candidate count, compatibility-profile count,
capability-context count, compatibility-evaluation count, active-family count, selectable-family
count, selected-candidate count and current-generation compatibility-consumer count all remain
zero. A-01 through A-08A production authority, v1 compatibility, canonical commerce/media,
`StorefrontSnapshot`, persistence, proposal, rendering, publication and Puck boundaries remain
unchanged. Focused A-08B tests and the inactive A-08C selector are the only direct current
consumers, with no current-generation runtime consumer.
...
P10B-19A-08C completes parent P10B-19A-08 with one inactive, side-effect-free deterministic
selection authority over exact A-07 candidates, A-08A normalized topology and replayed A-08B
compatibility evidence. It does not activate, materialize, persist, render or publish selected
authority and does not connect to current generation.

The strict deeply readonly request and policy schema versions are `1.0.0`. A trusted internal
request binds one bounded lowercase-kebab technical case identity, the exact A-08B evaluation
fingerprint, a nonempty canonical A-01 eligible-family set, and unique exact family-identity,
family-topology and previously selected complete-store-topology exclusions. Creation canonicalizes
all collections; parsing rejects stale or noncanonical material. Its fingerprint is
`structural-storefront-deterministic-selection-request-v1_<canonical-length>_<sha256>`.

Selection re-canonicalizes A-07, validates the supplied A-08A index exactly through A-08B replay,
and accepts only registry members that match exact A-07 identity/fingerprint and A-08A/A-08B
topology provenance. Family precedence is `directly-compatible` before
`conditionally-compatible`; PageBlueprint precedence is `directly-compatible` before
`substitution-compatible` before `omission-compatible`. Incompatible candidates are never
selectable. Equal-class ties compare `canonicalValueFingerprint` values built only from policy,
request, selected-family, exact candidate and normalized-topology authority, followed by exact
code-unit identity. No numeric score, weight, penalty, confidence, stored sort value, locale,
randomness, clock or input order controls the result.

For the selected family, one pool is built for each canonical page family: home, collection,
search, product-detail, content-support and utility. A substitution-compatible source follows the
first compatible candidate in exact A-06 priority and may recurse only to a direct or
omission-compatible terminal. A direct terminal declares no omission. An omission-compatible
terminal retains exact A-08B triggered optional regions in the A-03 default reading order; it does
not alter the A-03 or A-05 record or execute omission. Source/effective identities, the complete
substitution path, terminal status and omitted region IDs remain explicit receipt evidence.

The selector enumerates the six ordered pools as one lazy lexicographic Cartesian product. One
invocation-global fixed bound counts at most `4096` complete combinations and fails before a
`4097`th evaluation. Excluded complete-store topologies advance to the next combination and then
the next compatible family; exhausting all bounded compatible topologies fails closed without a
partial receipt.

Selected complete-store topology contains only schema version `1.0.0`, all six terminal A-08A
PageBlueprint topology fingerprints, omission tokens `r0`, `r1`, ... derived from effective A-03
reading order, and canonical A-02 cross-page relationships. Exact candidate/family identities,
substitution paths, request and compatibility statuses are excluded. Its fingerprint is
`structural-storefront-selected-complete-topology-v1_<canonical-length>_<sha256>`, so direct and
substitution routes reaching equal effective structure produce equal topology.

The strict deeply readonly receipt binds the exact request/evaluation, selected family, all six
source and effective page decisions, selected complete-store topology and
`structural-storefront-deterministic-selection-v1_<canonical-length>_<sha256>`. Receipt parsing
reruns selection and canonical-compares the complete result. Malformed, stale, incompatible,
contradictory, exhausted or over-budget authority returns no partial selection and never falls
back to v1.

The exported production A-07 registry and A-08B profile catalogue remain exactly empty. Production
selection-request, receipt, selected-family and selected-page record counts remain zero, and no
current generation, provider, Vesko, commerce/media, `StorefrontSnapshot`, persistence, proposal,
Puck, renderer or publication module imports or invokes A-08C. This task has no merchant-visible or
visual effect, creates no three-concept planner or roles, and reserves distinct-concept enforcement
for P10B-19H. P10B-19A-09 owns v1 read/render/migration/publication compatibility.
...
P10B-19A-09A begins the three-part v1 compatibility sequence without reading, classifying,
mutating, rendering, migrating or publishing a `StorefrontSnapshot`. The exact ordered alias
vocabulary is:

1. `legacy-v1:premium-editorial` -> `premium-editorial`
2. `legacy-v1:modern-technical` -> `modern-technical`
3. `legacy-v1:minimal-commerce` -> `minimal-commerce`

Each strict deeply readonly alias has schema version `1.0.0` and binds the exact current
coordinated-direction ID, imported authority version `1.1.0`, and current package authority
fingerprint. The sole populated compatibility registry contains exactly those three aliases in
that order, exposes no registration or mutation operation, and is protected by deterministic
alias and registry fingerprints. The aliases resolve current direction authority; they do not copy
direction packages or reinterpret them as Structural Storefront Families, PageBlueprint v2
records, Visual Recipe v2 identities, candidates, selections or activation records.

One strict replay reference retains a complete existing v1
`boundedStorefrontSynthesisSelectionNarrowingSchema` value. Creation resolves the exact alias,
requires the narrowing authority ID to name the aliased direction, and reuses
`validateDirectionSelectionNarrowing` for the current direction constraints. Executable replay
identity derives only through `boundedStorefrontSynthesisExactSelectionSchema`; no duplicate field
projection exists. The complete retained source selection still carries `selectionId` for audit,
but replay fingerprint material excludes that incidental selection-instance identifier. Changing
only `selectionId` therefore preserves executable replay identity, while changing any executable
direction, Design DNA, frame, profile, optional-page, posture or responsive authority changes it.
Malformed, unknown, mismatched or stale alias, direction, registry, narrowing or replay authority
fails closed without repair, fallback or nearest-direction inference.

No alias is inferred from snapshot contents, rendered appearance, profile overlap, frame
similarity or topology, and no unattributed state defaults to Minimal Commerce. This authority has
no current production generation consumer and causes no merchant-visible or visual change. It
does not prove that historical snapshots are readable, classified or render-equivalent; A-09B owns
historical snapshot read/render replay without write-back. It does not prove publication replay;
A-09C owns publication compatibility and parent A-09 closure. Current coordinated-direction,
generation, commerce/media, snapshot/history/persistence, Puck, renderer, Preview and publication
...
P10B-19A-09B adds one strict read-only adapter for historical snapshots that remain valid under
current canonical authority. It parses and validates the supplied catalogue, requires the exact
snapshot `catalogueRef`, validates the canonical repository snapshot, and revalidates registered
section context where required. It resolves current PageBlueprint-profile, shared-frame,
navigation/site-map, dynamic-commerce, canonical product and approved-asset authority used by the
snapshot. Unknown, malformed, stale, mismatched or noncanonical authority fails closed; no
fallback, nearest-match repair or write-back occurs.

The optional A-09A replay reference creates only an explicit compatibility binding. When present,
its alias resolves and revalidates exact current coordinated-direction authority, and all persisted
values must match exactly; the receipt disposition is `readable-explicit-replay-binding`. When
absent, the disposition is `readable-unattributed`; the adapter resolves no coordinated direction
and never infers an alias or original lineage from appearance, profiles, frame identity, topology
or a default direction. The bounded field partition reports seven present persisted selection
fields as verified—design-system spacing density, design-system surface depth, shared-frame
profile, homepage profile, collection profile, search profile and PDP profile—and reports seven
absent selection fields as unverified. Unverified fields are not reconstructed or claimed.

The adapter returns a detached, deeply immutable canonical snapshot and receipt at schema version
`1.0.0`. The receipt records canonical source identity and fingerprint,
persisted-authority projection fingerprint, optional explicit replay binding, normalization
disposition `none` or `canonical-read-defaults`, and the deterministic identity
`legacy-v1-historical-snapshot-read-v1_<canonical-length>_<sha256>`. Receipt parsing recomputes the
identity and rejects stale, unknown or contradictory records. Reading never saves, restores,
publishes, updates history, changes current generation or creates Structural Storefront Family,
PageBlueprint v2 or Visual Recipe v2 authority.

Frozen exact-base evidence records 36 bounded current-renderer observations: three representative
historical v1 snapshots across EN/FI and their selected home, collection, search, product, content
or utility surfaces. All 36 of 36 observation fingerprints match the frozen exact-base baseline.
Snapshot and route/profile/frame identities, canonical commerce, product media, approved assets and
locale observations remain equal, with zero snapshot mutation and zero repository write. The
evidence uses the current historical Preview target/path but adds no new Preview route and does not
exercise a published target or publication replay. It is semantic current-renderer replay, not raw
HTML equality, original-lineage recovery, migration, publication compatibility, v2 execution,
production operation or a merchant-visible change.
...
P10B-19A-09C composes the current canonical publication compiler over one exact validated A-09B
historical-read result and receipt. The input must bind the same source snapshot, project,
revision, catalogue reference and canonical snapshot fingerprint. An explicit A-09A alias/replay
reference, when present, is consumed only through the already-validated A-09B receipt; A-09C does
not import A-09A directly or infer missing historical lineage.

Compilation creates a detached transient aggregate projection in which the historical snapshot is
the saved draft and invokes the existing compiler with truthful `manual` source authority. It
never mutates the supplied source snapshot or aggregate, never saves the projection, and never
adds publication metadata to `StorefrontSnapshot`. Existing migration inspection must report
`current`; unresolved migration fails closed and no migration or compatibility write-back occurs.

The strict deeply readonly receipt has schema version `1.0.0` and authority
`legacy-v1-historical-publication-replay`. It binds the A-09B receipt fingerprint and disposition,
the bounded optional replay binding, canonical source snapshot identity, and the current compiler
contract, compiler, runtime, validation, compile-receipt and migration fingerprints. Its identity
is `legacy-v1-historical-publication-replay-v1_<canonical-length>_<sha256>`. Parsing recomputes the
receipt identity; current-authority assertion recompiles and rejects any malformed, stale,
mismatched, unresolved or contradictory receipt or compilation without partial publication.

Frozen exact-base evidence covers three representatives. Three direct A-09C compilations match
three deterministic `preparePublish` compilations exactly, and preparation performs zero writes.
Exactly three isolated `confirmPublish` executions preserve atomic current publication behavior:
each adds exactly one compiled-publication version and activates the exact new artifact while the
source aggregate and snapshot remain unchanged. All 36 of 36 published renderer observations
match the task-base publication authority. All 36 of 36 normalized Preview/published structural
observations also match after excluding only explicit target and route-context differences.
Canonical commerce and media remain unchanged; provider calls, Vesko calls and external
publication calls are zero.

A-09C is directly imported only by bounded evidence and is not exported from a client-reachable
publication barrel. Production A-09C receipt count, current-generation consumer count,
current-publication UI consumer count and all production v2 candidate/active/selected counts
remain zero. This authority adds no merchant-visible change, performs no real merchant or Vesko
publication, infers no original lineage, rewrites no snapshot and activates no v2 generation.
A-09A identity, A-09B read/render and A-09C publication replay together close only the accepted
parent P10B-19A-09 outcome.
...
P10B-19A-10 is delivered through three dependency-ordered children without changing the accepted
P10B-19 architecture: A-10A owns the retained inventory and frozen baseline; A-10B owns the
cross-authority integration and negative-failure matrix; A-10C owns complete retained execution,
the closure report and product-owner architecture gate. A-10A does not prove complete
cross-authority integration. A-10B is further delivered through A-10B1 positive integration and
A-10B2 fail-closed failure coverage and parent closure. A-10B1 does not close A-10B or P10B-19A,
and only A-10C may close P10B-19A and
move exact-next status to P10B-19B-01.

The checked fixture `tests/fixtures/p10b-19a-10a-retained-matrix-inventory.v1.json` is the
fresh-clone-safe retained-inventory authority and stable frozen input for A-10B and A-10C. Its
strict version `1.0.0` authority kind is `p10b-19a-retained-matrix-inventory`. Twenty-four explicit
matrix entries bind the retained P10B-18C and frozen P10B-18A matrices, every focused A-01 through
A-09C authority, v2 inactivity, current-generation and client-runtime isolation, and current
DEVX-01 CI discovery. The fixture records exact commands and bounded semantic outcomes; it contains
no snapshots, catalogue data, HTML, screenshots, assets, merchant content, provider payloads,
credentials or environment values.

The frozen semantic baseline remains 126 complete cases, 126 successful compiles and 126
deterministic replays, with 98 consumed-authority lineages, 54 normalized material topologies, 54
direction-label-free topologies, 34 repeated clusters, 106 repeated memberships, largest cluster
14 and 20 singletons. The exact retained 72-case subset remains 39 normalized topologies, 53
repeated memberships, largest cluster 7 and 19 singletons. A-09 remains exact at three aliases,
three historical representatives, 36 of 36 Preview observations, three of three direct
compilations, preparations, isolated confirmations and current migration dispositions, 36 of 36
published observations and 36 of 36 normalized Preview/published parity observations. Repository
writes, source mutations, provider calls, Vesko calls and external-publication calls remain zero.

Seventy-six canonical production-authority paths bind exact task-base SHA-256 values. Nine
explicit production inactivity assertions remain zero: PageBlueprint candidates, Structural
Family candidates, compatibility profiles, capability contexts, compatibility evaluations,
selection requests, selection receipts, active families and selectable families. Runtime CI
discovery is audited through the existing DEVX-01 Vitest discovery and shard planner rather than a
frozen shard count; every inventoried test appears exactly once, including this task's test.

The canonical inventory identity is
`p10b-19a-retained-matrix-inventory-v1_32375_1b97e7da8eebdcda779b51b91b2f540263c97e9d2b40950b7f002721b6a5eb7d`.
It binds schema, authority kind, task base, canonical matrix entries, protected-source hashes,
inactivity assertions and semantic metrics while excluding its own fingerprint and machine-local
state. The read-only `/private/tmp` copy corroborates generation provenance but is not required to
validate a fresh clone. There is no automatic baseline-update path; altered metrics, commands,
source hashes, case-set identities, missing A-09 baselines or stale fingerprints fail closed.

A-10A changes no production file, creates no v2 production record and connects no v2 authority to
current generation. It adds no renderer, publication, provider, Vesko, Puck, visual or
merchant-visible behavior and makes no P10B-19A closure claim. The frozen fixture is the stable
input for A-10B.
...
P10B-19A-10B is delivered through two dependency-ordered, delivery-only children without changing
the accepted 73-child P10B-19 architecture. A-10B1 owns positive cross-authority integration.
A-10B2 owns the Fail-Closed Cross-Authority Failure Matrix and A-10B Closure.

The checked fixture contains eight PageBlueprint v2 candidates—six primary and two product-detail
fallback candidates—six Structural Storefront Family candidates, six compatibility profiles,
three capability contexts, six exact family roles/IDs and three normalized family-topology groups
of two exact identities. Positive integration proves two-hop product-detail substitution, optional
content/support omission, six family-constrained receipts and three sequential pairwise
topology-distinct receipts.

Direct EN and direct FI each classify all eight PageBlueprint candidates and all six families as
directly compatible. Their context and evaluation identities differ, as do the fixture's stable
technical request and receipt identities, while normalized structural topology remains
locale-independent. Mixed fallback classifies five PageBlueprints directly compatible, two
substitution-compatible and one omission-compatible, with all six families conditionally
compatible. The fresh-clone authority is checked in at
`tests/fixtures/p10b-19a-10b1-positive-cross-authority-integration.v1.json`.

A-09 coexistence remains unchanged. The frozen A-10A fixture remains byte-identical with 24 matrix
entries, 76 protected production-source hashes and nine production-inactivity assertions.
Accepted 126/72 and A-09 metrics remain unchanged. Production files changed remain zero; no v2
production record, current-generation reachability, client-runtime reachability, provider call,
Vesko call, external publication, visual behavior or merchant-visible behavior is introduced.

The canonical positive-integration baseline fingerprint is
...
`907a4d48cab6dacd0bc46e0fb16d4eca2ca82c87d7f00b605ca53f3f112490f2`. The read-only external
baseline SHA-256 is `2f181f551e7b44e5429f3b67cd4f381aaf98fcf996196af75d852e67b3d435ab`
and corroborates the checked authority without becoming a fresh-clone
dependency. Fingerprint, fixture, external authority, frozen A-10A identity and semantic outcomes
fail closed on drift.

`P10B-19A-10A = Baseline`; `P10B-19A-10B1 = Baseline`;
`P10B-19A-10B2 = Baseline`; `P10B-19A-10B = Baseline / closed`;
`P10B-19A-10C = Baseline`; `P10B-19A-10 = Baseline / closed`;
`P10B-19A = Baseline / closed`; `P10B-19B-01 = exact next implementation task`;
`P10B-19 = Partial`; `P10B = Partial`.

### 10.46 P10B-19A-10B2 Fail-Closed Cross-Authority Failure Matrix and A-10B Closure

P10B-19A-10B2 is test/evidence authority only. It starts each of exactly 36 ordered failure cases
from a fresh `createPositiveCrossAuthorityIntegrationAuthority` result, applies one logically
atomic corruption to a clone of the tested input and invokes the highest canonical A-03 through
A-09C owner boundary. Every case records its exact owner and terminal phase, completes zero later
phases, returns zero partial outputs and leaves the complete source authority fingerprint
unchanged.

The baseline retains 20 sorted Zod issue code/path projections and 16 typed-error projections.
Exactly cases 17, 18 and 20 use canonical native `Error` observations with null `errorCode` and
null issue-path fingerprint; the remaining 13 typed failures retain stable canonical error codes.
Case 25 retains its governed ID and binds contradictory substitution authority to
`stale-selection-authority`. Case 28 treats substitution of the coherent production-empty root
authority and deterministic recomputation of its topology, context, profile, evaluation and
request dependents as one atomic replacement, ending with `no-eligible-family-candidates`. Four
legacy-v1/v2 authority substitutions are passed directly to the wrong strict receiver and fail
without casts, adapters, coercion or inference.

Every observation records zero automatic repair, silent normalization, v1/v2 fallback, default
candidate, partial receipt, partial publication, snapshot/catalogue/commerce/media mutation,
repository write, publication confirmation, provider call, Vesko call and external publication.
Production source changes remain zero. PageBlueprint candidates, Structural Storefront Family
candidates, compatibility profiles, capability contexts, compatibility evaluations, selection
requests, selection receipts, active families and selectable families remain zero in production;
no current-generation or client-runtime reachability is introduced.

The fresh-clone authority is checked in at
`tests/fixtures/p10b-19a-10b2-fail-closed-cross-authority-matrix.v1.json`. Its canonical baseline
fingerprint is
`p10b-19a-fail-closed-cross-authority-matrix-v1_30308_ffae8e9700b84c08fcf1fe7315846077b01170f0be0d82743dce4e8a0ac8d307`;
its checked fixture SHA-256 is
`8708a2282749796c9d27d2dcd382384989c7738a5eb0b2f72f87c1ad73cb6a64`; its canonical material
SHA-256 is `ffae8e9700b84c08fcf1fe7315846077b01170f0be0d82743dce4e8a0ac8d307`. The mode-0444
corroborating external mirror has SHA-256
`67945a1b29cc4e84623c17cc2d2c0454265717599cd1128c7adfbb0446935b0b` and is not a fresh-clone
dependency. The exact task base is `29f03e3e1c00c33e07cae93872877b604342f6dc`.

All seven frozen A-10A/A-10B1 files remain byte-identical. A-10A remains 24 matrix entries, 76
protected production-source hashes and nine production-inactivity assertions; accepted 126/72
and A-09 metrics remain unchanged. A-10B1 retains eight PageBlueprint candidates, six family
candidates, six compatibility profiles and three capability contexts. Together A-10B1 positive
integration and A-10B2 negative integration complete parent A-10B without production, visual,
provider, Vesko, publication-confirmation, image-generation, secret-file or merchant-visible
activity. This nested delivery decomposition does not renumber or expand the accepted 73-child
architecture.
...
P10B-19A-10C is test, evidence and constitutional-documentation authority only. At exact task base
`f9af2b2f007ff1bcb0f20a046edf33bc1f10ea37`, it executes the sorted unique 26-file retained plan,
proves each inventoried test is discovered exactly once by current DEVX-01 CI and remains assigned
exactly once by the current Vitest shard authority, and closes the structural architecture package
without changing production source. The checked fresh-clone authority is
`tests/fixtures/p10b-19a-10c-architecture-closure-manifest.v1.json`.

The product owner supplied the exact decision
`ACCEPT P10B-19A STRUCTURAL ARCHITECTURE CLOSURE`, accepting candidate
...
The final closure fingerprint is
`p10b-19a-structural-architecture-closure-v1_12651_76316ec1e4c4edc48b02942ec27624b6a05926b91cf11dbcf08a64c65d18e728`;
its canonical material SHA-256 is `76316ec1e4c4edc48b02942ec27624b6a05926b91cf11dbcf08a64c65d18e728`.
The checked fixture SHA-256 is `757c0febf40da2e893f99795dc12bbf1e5bf933fe55b326cab512f80f35d67b1`,
and the read-only external baseline SHA-256 is
`529da1152e5d088a9ff3bff075829d8f22f5b4bed95446eac119f9d79e338122`.

All 11 frozen A-10A/A-10B1/A-10B2 predecessor files remain byte-identical. The retained A-10A
inventory remains exactly 24 matrix entries, 76 protected production-source SHA-256 records and
nine production-inactivity assertions. Accepted complete-126, frozen-72 and A-09 semantic metrics
remain unchanged; the positive A-10B1 authority and exact 36-of-36 A-10B2 fail-closed authority
remain unchanged. No baseline is regenerated or replaced.

The immutable architecture lock remains
`docs/P10B_19_STRUCTURAL_DESIGN_INTELLIGENCE_ARCHITECTURE.md` at SHA-256
`5292792dae97273411702eeaf468575172c0cf46b026103216423de29eaf47fd`, with 21 numbered sections,
four Mermaid diagrams, 73 accepted architecture children and zero nested-delivery child delta.
Production PageBlueprint candidates, Structural Storefront Family candidates, compatibility
profiles, capability contexts, evaluations, selection requests, receipts, active families and
selectable families remain zero. Production-source changes, current-generation P10B-19A consumers,
client-runtime consumers, merchant-visible changes, provider calls, Vesko calls, external
publication calls, A-10C publication preparation/confirmation, image generation and secret-file
access also remain zero. No current-generation or client-runtime reachability is introduced.

The accepted limitations remain, in exact order:

1. `no-active-v2-family`
2. `no-v2-rendered-storefront`
3. `no-visual-recipe`
4. `no-design-dna-v2`
5. `no-v2-frame-family`
6. `no-v2-page-family-realization`
7. `no-ai-design-director`
8. `no-screenshot-critic`
9. `no-live-ai-quality-evidence`
10. `no-v2-commercial-quality-claim`

Architecture acceptance is not merge authority. A-10C has no product-owner screenshot gate because
it introduces no merchant-visible output. P10B-19B-01 has not begun; after A-10C merges it is the
exact next implementation task, `VisualRecipeIntentV1 Safe Schema and Capability Projection`.
`P10B-19A-10C = Baseline`; `P10B-19A-10 = Baseline / closed`;
`P10B-19A = Baseline / closed`; `P10B-19B-01 = exact next implementation task`;
`P10B-19 = Partial`; `P10B = Partial`.
